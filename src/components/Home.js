...
export default function Home() {
  return (
    <div className="relative bg-[#013f28] overflow-hidden h-screen">
      <div
              ...
              <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                <div>
                  ...
                  <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                    Easy life is a platform that gives you access to make
                    donations to different charity organizations. We are trying
                    to make it easy for charity homes to recieve donation and
